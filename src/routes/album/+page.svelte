<script>
  ...
  <main class="flex items-center justify-center h-screen bg-gradient-to-r from-purple-500 to-pink-500 text-white">
    <div class="text-center p-8 rounded-lg bg-white bg-opacity-20 shadow-lg w-96">
      ...
      <div class="grid grid-cols-2 gap-4">
        <img src="{pnj1} " alt="Imagem 1" class="rounded-lg shadow-lg" />
        <img src="{pnj2} " alt="Imagem 2" class="rounded-lg shadow-lg" />
        <img src="{pnj3} " alt="Imagem 3" class="rounded-lg shadow-lg" />
        <img src="{pnj4} " alt="Imagem 4" class="rounded-lg shadow-lg" />
      </div>
      <button 
